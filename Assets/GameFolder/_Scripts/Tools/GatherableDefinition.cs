...
using TweenFeedback = SKC.AIF.Feedbacks.TweenFeedback;

namespace SKC.AIF.Tools
{
	[CreateAssetMenu(menuName = nameof(AIF) + "/" + nameof(Tools) + "/" + nameof(GatherableDefinition))]
	public class GatherableDefinition : ScriptableObject
	{
		...
		public ObjectPool GatheringOutputItemPool { get; private set; }
